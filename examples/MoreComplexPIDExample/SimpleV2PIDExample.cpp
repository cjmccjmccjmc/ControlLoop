...
#include "WaterBucketSlowValveModel.hpp"
...
const int TIME_TO_FULLY_OPEN_VALUE_FROM_CLOSED = 10;

WaterBucketSlowValveModel theBucket(MAX_WATER_IN_LITRES_MINUTE, LEAK_OUT_LITRES_PER_MINUTE, TIME_TO_FULLY_OPEN_VALUE_FROM_CLOSED);
...
//  theControlLoop.setTunings(0.48, 7.5, 1.875);
  theControlLoop.setTunings(0.48, 7.5, 1.0);
