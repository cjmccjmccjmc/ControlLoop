...
const long SECONDS_TO_ADVANCE_MODEL = 60;
const int ACTUAL_TIME_TO_WAIT_BETWEEN_ADVANCES = 1000;
...
const double MAX_WATER_IN_LITRES_MINUTE = 2;
const double LEAK_OUT_LITRES_PER_MINUTE = 1;
